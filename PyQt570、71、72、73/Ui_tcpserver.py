...
# Form implementation generated from reading ui file 'F:\PyQt5\source_code_for_pyqt5_tutorials\PyQt570\tcpserver.ui'
#
...
class Ui_TcpServer(object):
    ...
    def retranslateUi(self, TcpServer):
        ...
        TcpServer.setWindowTitle(_translate("TcpServer", "微信公众号：学点编程吧--发送端"))
